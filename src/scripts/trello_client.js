// unminimized coffescript converted to javascript
    ...
    if (localStorage != null) {
        ...
        writeStorage = function(key, value) {
            if (value === null) {
                ...
                /* adding chrome storage component */
                //var stgKey = storagePrefix + '' + key;
                //chrome.storage.local.set({stgKey : value}, function(){});
