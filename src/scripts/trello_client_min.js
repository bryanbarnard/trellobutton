//https://api.trello.com/1/client.js?key=a17fd12937c7b07ed2ab56a5531bc395

(function () {
    var opts = {"version": 1, "apiEndpoint": "https://api.trello.com", "authEndpoint": "https://trello.com", "key": "a17fd12937c7b07ed2ab56a5531bc395"};
    ...
    wrapper = function (c, g, b) {
        ...
        f = {version: function () {
            ...
            var q, d, k, f, h;
            b = g.extend(!0, {type: "redirect", persist: !0, interactive: !0, scope: {read: !0, write: !1, account: !1}, expiration: "30days"}, a);
            a = /[&#]?token=([0-9a-f]{64})/;
            d = function () {
            ...
            switch (b.type) {
                case "popup":
                    (function () {
                        ...
                        return c.open(w({return_url: q, callback_method: "postMessage", scope: k, expiration: b.expiration, name: b.name}), "trello", "width=420,height=470,left=" + a + ",top=" + e)
                    })();
                    break;
                default:
                    c.location = w({redirect_uri: n.href, callback_method: "fragment", scope: k, expiration: b.expiration, name: b.name})
            }
        }};
        ...
        u = function (a) {
            return f[a] = {get: function (b, c, d, e) {
