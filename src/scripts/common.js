...
var trellobutton = {
            ...
            if (response.success) {
                if (opts.observe) {
                    var observer = new MutationObserver(function (mutations) {
                        trellobutton.renderTo(selector, renderer);
                    });
    ...
    createTimerLink: function (params) {
        var link = createLink('trello-button');
        ...
        link.addEventListener('click', function (e) {
            ...
            if (this.isStarted) {
                ...
                opts = {
                    ...
                    createdWith: 'TrelloButton - ' + params.className
                };
            }
